  ...
  describe(taskDesc, () => {
    ...
    it("should be in the correct format", async () => {
      ...
      expect(results.images).toContain({
        ...
        url:
          "http://static.wixstatic.com/media/cc9d8bc0f8b1a5338ee79d9eb155d1c4.wix_mp",
        title: "small dogs"
      });
      ...
      expect(results.images).toContain({
        ...
        url:
          "http://static.wixstatic.com/media/fb376dd2473759bbb248dc4f1b23730e.wix_mp",
        title: "dogfood"
      });
      ...
      expect(results.images).toContain({
        ...
        url:
          "http://static.wixstatic.com/media/85252fdf939e9b37fa16d1f3b2d197e9.wix_mp",
        title: "dog run"
      });
      ...
      expect(results.images).toContain({
        ...
        url:
          "http://static.wixstatic.com/media/16f9f8e6e00718d108a8889351874fb4.wix_mp",
        title: "book dog"
      });
      ...
      expect(results.images).toContain({
        ...
        url:
          "http://static.wixstatic.com/media/7f093ca6c9945ebb918772e55cd7b89f.wix_mp",
        title: "office dog"
      });
    });
  });
