...
const taskDesc = `<p>Alter your code so that it will have consistent APIs. Your solution should allow the <code>search()</code> method to be able to accept requests from multiple galleries and route the search results to the appropriate gallery instance.</p>
<p><strong><li>Bonus</strong> - Add a second functioning gallery</li></p>`;
